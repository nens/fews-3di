...
def test_add_laterals(example_settings):
    ...
    threedi_simulation.simulations_api.simulations_events_lateral_timeseries_create = mock.MagicMock(
        return_value=mock_lateral
    )
    mock_lateral2 = mock.Mock()
    mock_lateral2.state = "valid"
    threedi_simulation.simulations_api.simulations_events_lateral_timeseries_read = mock.MagicMock(
        return_value=mock_lateral2
    )
